                        ...
                        @foreach ($posts as $key => $d)
                            <tr class="hover:bg-grey-lighter">
                                <td class="py-4 px-6 border-b border-grey-light">
                                    {{ ($posts->currentpage() - 1) * $posts->perpage() + $key + 1 }}</td>
                                <td class="py-4 px-6 border-b border-grey-light">{{ $d->nama }}</td>
                                <td class="py-4 px-6 border-b border-grey-light">Rp{{ $d->harga }}</td>
                                <td class="py-4 px-6 border-b border-grey-light">
                                    {{ $d->category->name_cat }}
                                </td>
                                <td class="py-4 px-6 border-b border-grey-light">
                                ...
                                <td class="py-4 px-6 border-b border-grey-light">
                                    <div class="flex">
                                        <a href="{{ route('edit_obat', ['id' => $d->id]) }}"
                                        ...
                                        <a href="{{ route('delete_obat', ['id' => $d->id]) }}"
