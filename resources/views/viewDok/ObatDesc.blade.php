    ...
    <section class="text-gray-700 body-font overflow-hidden bg-white h-screen">
        <div class="container px-5 py-6 mx-auto">
            <div class="lg:w-4/5 mx-auto flex flex-wrap">
                <img alt="ecommerce" class="lg:w-5/12 w-1/4 h-full object-cover object-center rounded border border-gray-200"
                    src="{{ url($posts->image) }}">
                <div class="lg:w-1/2 w-full lg:pl-10 lg:py-6 mt-6 lg:mt-0">
                    ...
                    <div class="flex">
                        ...
                        <button
                            class="flex ml-auto text-white border-0 py-2 px-6 focus:outline-none  bg-yellow-500/80 hover:bg-yellow-500/90 rounded">Add to Cart
                            </button>
                        <button
