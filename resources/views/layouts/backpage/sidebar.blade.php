<aside class="relative bg-sidebar h-screen w-64 hidden sm:block shadow-xl">
    <div class="p-6">
        <a href="index.html" class="text-white text-2xl font-semibold uppercase hover:text-gray-300">Puskesmas</a>
        <button
    ...
    <nav class="text-white text-base font-semibold pt-3">
        ...
        <a href="{{ route('admin') }}" class="nav-link flex items-center text-white opacity-75 hover:opacity-100 py-4 pl-6 nav-item">
